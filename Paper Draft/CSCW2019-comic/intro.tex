...
From online charitable donation to open source software development, technology advancement expands people?s ways to contribute to public goods. Research have shown that such collective action is essential to social prosperity ~\textcite{}. However, public goods cannot be confined solely to those who have paid for it, there is no tangible utility for people to contribute ~\textcite{}. Without individual?s contribution, some public goods such as knowledge and charity may scare. Therefore, extensive efforts had been put to understand how to nudge people to contribute.

Although people can take "free-ride" on public goods, some people still actively contribute for some intrinsic reasons including altruism ~\textcite{}, reciprocity~\textcite{}, and personal satisfaction ~\textcite{}. On the other hand, when people making decision on devoting their money, time, and efforts to public goods, there were factors from outside world influencing other than altruistic causes. Nudges from the organizations or governments are one of the most influential factors. Those nudges were often in a pure-textual form and framed to persuade people to provision their money, time and efforts to public goods. For example, Wikipedia, world?s largest free encyclopedia that written by volunteers, raised over 30 million funds in 2017 through a text banner on the top of each article. To equip persuasive messages with sufficient power, researchers in multiple fields such as psychology, communication and behavioral economics discovered and concluded a set weapons of influence, such as social proof, authority, and scarcity ~\textcite{}. 

While those persuasive techniques have made persuasive messages appeal more, human beings show significant resistance to contributing to public goods. Although there may be confounds that explain away poor adoption, including, message timing~\textcite{Fogg2009} (i.e. when we show the fact), time scarcity~\textcite{Janssen2016} (i.e. we don't have time to digest the information), viewing messages on smartphones~\textcite{Kim2016} (screen is too small to communicate effective visualizations), rethinking the textual form of the message for easier consumption in the context of behavior change has been largely unexplored.

In this study, we asked are text messages (e.g. "Would you like to donate to support the organization for autism research?") more persuasive expressed in comic\footnote{We use ``comic form'' as opposed to the more formal ``graphic form'' to avoid any confusion with other visual representations of data, including charts and diagrams.} form especially in encouraging charitable donation? 

%Two ideas underpin this paper: information framing, ``social proof,'' and the comic form an . First, work in Behavioral Economics~\cite{tversky1992advances,tversky1981framing} shows that how we frame the text matters and can cause preference reversal. Briefly, individuals show different preferences to statements with identical information due to risk aversion.
