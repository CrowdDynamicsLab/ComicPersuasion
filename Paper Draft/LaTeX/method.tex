...
\begin{figure}[t]
    \centering
    \begin{tabular}{c}
    \subfloat[Three levels of gesture intensity for positive framed messages from neutral to the happiest]{\label{figur:1a}\includegraphics[width = 0.5 \columnwidth]{figures/pos_figures}} \\
    \subfloat[Three levels of gesture intensity for negative framed messages from neutral to the most frustrated ]{\label{figur:1b}\includegraphics[width = 0.5 \columnwidth]{figures/neg_figures}}\\
    \end{tabular}
