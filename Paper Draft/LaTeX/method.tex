...
In this study, we investigated persuadee's perceived persuasiveness of persuasive comics through an online study. In this section, we will first introduce
...
To make a fair comparison between plain text representation and the comic form, the content of text information is the same in both conditions.
In total, for each message we have a total of 54 variations in terms of character gesture, inter-character, background shading, and message framing. In this study, 270 comics was created corresponding to 10 plain text messages, e.g. Figure ~\ref{figur:distance},Figure~\ref{figur:shading}.
